...
<div class={cn("relative w-full", classCn)}>
  <button
    ...
    class="bg-base-100 hover:bg-base-200 border-base-300 flex w-full items-center justify-between rounded-md border px-3 py-2 text-left text-sm outline-none"
    onclick={() => (open = !open)}
    onkeydown={(e) => {
        ...
        {#each choiceList as choice (choice)}
          <button
            ...
            class={cn(
              ...
              value === choice ? "bg-base-200 text-primary-content font-semibold" : "",
