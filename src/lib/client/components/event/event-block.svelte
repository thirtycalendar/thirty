...
<button
  class="text-primary-content border-primary-content/10 focus:outline-primary-content absolute z-10 flex cursor-pointer items-start gap-1 overflow-hidden rounded-md border p-0 shadow-md backdrop-blur-md transition-shadow duration-200 select-none hover:shadow-lg"
  style={`
    top: ${topPx}px;
